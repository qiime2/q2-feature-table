...
class TabulateSeqsTests(TestCase):
    ...
    def test_basic(self):
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            with open(expected_fp) as fh:
                ...
                self.assertTrue('4' in file_text)
                self.assertTrue('seq2' in file_text)
    ...
    def test_optional_inputs(self):
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            with open(expected_fp) as fh:
                file_text = fh.read()
                self.assertTrue('8' in file_text)
                self.assertTrue('1' in file_text)
                self.assertTrue('10' in file_text)
                self.assertTrue('3.62' in file_text)
                self.assertTrue('9' in file_text)
                self.assertTrue('1' in file_text)
                self.assertTrue('1' in file_text)
                self.assertTrue('2' in file_text)
                self.assertTrue('3' in file_text)
                self.assertTrue('4' in file_text)
                self.assertTrue('6' in file_text)
                self.assertTrue('a;b;e;d' in file_text)
                self.assertTrue('a;b;c;d' in file_text)
                self.assertTrue('08' in file_text)
                self.assertTrue('17' in file_text)
